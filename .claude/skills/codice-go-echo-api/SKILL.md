...
- Preservar framework existente. Em API nova, usar o padrão confirmado pelo projeto; se a escolha não tiver evidência e for material, encaminhar a Sofia. Não impor Echo ou uma versão com base no resumo.
