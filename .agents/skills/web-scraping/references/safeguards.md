...
- Use low concurrency and cache responses during development.
- Make selectors and expected page markers configurable where appropriate.
- Redact cookies, tokens, query secrets, and personal values from logs and fixtures.
